    ...
    <div className="page-root">
      <main className="page-container">
        <header className="page-header">
          ...
          <h1 className="page-title">Personal Loan EMI Calculator</h1>
          <p className="page-subtitle">
            Estimate EMI, total interest and total repayment for a personal loan with
            shorter tenure and higher interest rates.
          </p>
        ...
        <div className="card">
          <div className="grid grid-2">
            ...
            <div>
              <div className="field">
                <label className="label">Personal Loan Amount (₹)</label>
                <input
                  className="input"
                  type="number"
                  value={principal}
