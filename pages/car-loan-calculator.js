    ...
    <div className="page-root">
      <main className="page-container">
        <header className="page-header">
          ...
          <h1 className="page-title">Car Loan EMI Calculator</h1>
          <p className="page-subtitle">
            Plan your vehicle purchase by estimating EMI and total car loan cost.
          </p>
        ...
        <div className="card">
          <div className="grid grid-2">
            ...
            <div>
              <div className="field">
                <label className="label">Car Loan Amount (₹)</label>
                <input
                  className="input"
                  type="number"
                  value={principal}
